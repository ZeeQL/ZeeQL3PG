...
class PostgreSQLExpressionTests: XCTestCase {
    
  let factory = PostgreSQLExpressionFactory()
  ...
  func testUpdateSQLExpr() {
    ...
    XCTAssertEqual(expr.statement,
      "UPDATE \"company\" SET \"age\" = 42, \"name\" = $1 WHERE \"id\" = 5",
      "unexpected SQL result")
